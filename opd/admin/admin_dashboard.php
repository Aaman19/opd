        ...
        <form id = "myModal" class="form-val" action="new_doctor_action.php"  method="post" name="myform" onsubmit="return validateForm()">
          ...
          <div class="mb-3" id="dob">
            ...
            <div class="input-group date" data-provide="datepicker">
                <input type="date" class="form-control" name="d_dob" id="d_dob" >
          ...
          <div class="mb-3" id = "password">
            ...
            <input type="password" class="form-control" id="recipient-name" name="d_password" id="d_password" autocomplete="new-password">
            <b style="color: red"><span class ="formerror"></span></b>
          </div>
            ...
            <table class="table table-bodererd">
              ...
              <tbody>
                ...
                if(isset($_POST['search_by_name']))
                {
                    ...
                    $query = "SELECT * FROM doctor_info WHERE d_name LIKE '$name%' ";
                ...
                <tr>
                  ...
                  <td><?php echo (date("Y") - date_format( date_create($row['d_dob']),"Y")); ?> (<?php echo $row['d_gender'] ?>)</td>
