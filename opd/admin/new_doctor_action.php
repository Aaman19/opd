...
$sql = "INSERT INTO `doctor_info` ( `d_name`, `d_dob`, `d_gender`, `d_contact`, `d_email`, `d_address`, `d_specialization`, `d_hospital_name`, `d_uname`, `d_password`) VALUES (  '$name', '$dob', '$gender', '$contact', '$email', '$address', '$specialization', '$hospital', '$username', '$hash')";
